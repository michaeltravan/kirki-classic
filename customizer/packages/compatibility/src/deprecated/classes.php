...
if ( ! class_exists( 'KirkiClassic_Active_Callback' ) ) {
	// Removed in https://github.com/aristath/kirki/pull/1682/files
	class KirkiClassic_Active_Callback {
		...
		public static function compare( $value1, $value2, $operator ) {
			_deprecated_function( __METHOD__, '3.0.17', 'KirkiClassic_Helper::compare_values' );
			return KirkiClassic_Helper::compare_values( $value1, $value2, $operator );
		}
	}
}
 ...
 */
if ( ! class_exists( 'KirkiClassic_CSS_To_File' ) ) {
	class KirkiClassic_CSS_To_File {
